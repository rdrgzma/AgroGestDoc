...
<p><strong>Nome do Cônjuge:</strong> {{ $conjuge->nome }} &nbsp;&nbsp;
    <strong>CPF:</strong> {{ $conjuge->cpf }}</p>
<p><strong>Apelido:</strong> {{ $conjuge->apelido ?? '-' }} &nbsp;&nbsp;
    <strong>Estado Civil:</strong> {{ ucfirst($conjuge->estado_civil) }}</p>
<p><strong>Cor/Raça:</strong> {{ $conjuge->raca ?? '-' }}</p>
